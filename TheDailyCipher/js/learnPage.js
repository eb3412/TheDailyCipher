                ...
                requestAnimationFrame(() => {
                    ...
                    try {
                        ...
                        if (contentHeight > 0) {
                            ...
                            const cap = viewportWidth <= 650 ? 540 : (viewportWidth <= 900 ? 600 : 640);
                            const targetHeight = Math.min(contentHeight + 2, cap);

                            frame.style.height = `${targetHeight}px`;
                            frame.style.maxHeight = `${cap}px`;
                            frame.setAttribute("scrolling", contentHeight > cap ? "yes" : "no");
